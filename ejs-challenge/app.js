...
app.get("/", function(req, res) {
  Post.find({}, function(err, foundPosts) {
    ...
    res.render("home", {startContent: homeStartingContent, newPosts: foundPosts});
  });
});
...
app.post("/compose", function(req, res) {
  ...
  // const post = {title: req.body.composeTitle, post: req.body.composeText};
  // posts.push(post);
...
app.get("/posts/:postName", function(req, res) {
  ...
  Post.find({}, function(err, foundPosts) {
    ...
    foundPosts.forEach(function(foundPost) {
      const postCheck = lodash.lowerCase(foundPost._id);
      const postName = lodash.lowerCase(req.params.postName);
      if(postName === postCheck) {
        res.render("post", {title: foundPost.postTitle, content: foundPost.postText});
      }
  });
});
  // posts.forEach(function(post) {
  //
  //   const postCheck = lodash.lowerCase(post.title);
  //   const postName = lodash.lowerCase(req.params.postName);
  //   if(postName === postCheck) {
